...
use pipeline_domain::entities::{ProcessingContext, StageConfiguration, StagePosition, StageType};
...
mod tests {
    ...
    use pipeline_domain::entities::{Operation, SecurityContext, SecurityLevel};
