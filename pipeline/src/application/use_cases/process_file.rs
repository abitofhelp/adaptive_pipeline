...
use pipeline_domain::services::PipelineService;
...
impl ProcessFileUseCase {
    ...
    fn create_pipeline_service(
        ...
        let mut stage_services: HashMap<
            String,
            Arc<dyn pipeline_domain::services::StageService>,
        > = HashMap::new();

        // Register compression algorithms
        stage_services.insert(
            "brotli".to_string(),
            compression_service.clone() as Arc<dyn pipeline_domain::services::StageService>,
        );
        stage_services.insert(
            "gzip".to_string(),
            compression_service.clone() as Arc<dyn pipeline_domain::services::StageService>,
        ...
        stage_services.insert(
            "aes256gcm".to_string(),
            encryption_service.clone() as Arc<dyn pipeline_domain::services::StageService>,
        );
        stage_services.insert(
            "aes128gcm".to_string(),
            encryption_service.clone() as Arc<dyn pipeline_domain::services::StageService>,
        ...
        stage_services.insert(
            "base64".to_string(),
            Arc::new(Base64EncodingService::new()) as Arc<dyn pipeline_domain::services::StageService>,
        );
        stage_services.insert(
            "pii_masking".to_string(),
            Arc::new(PiiMaskingService::new()) as Arc<dyn pipeline_domain::services::StageService>,
        );
        stage_services.insert(
            "tee".to_string(),
            Arc::new(TeeService::new()) as Arc<dyn pipeline_domain::services::StageService>,
        );
        stage_services.insert(
            "passthrough".to_string(),
            Arc::new(PassThroughService::new()) as Arc<dyn pipeline_domain::services::StageService>,
        );
        stage_services.insert(
            "debug".to_string(),
    ...
    fn display_processing_summary(
        ...
        metrics: &pipeline_domain::entities::ProcessingMetrics,
        pipeline: &pipeline_domain::entities::Pipeline,
