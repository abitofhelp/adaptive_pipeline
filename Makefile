...
build-linux-x86_64: ## Build for Linux x86_64
	...
	@CROSS_LOG=info cross build --release --target x86_64-unknown-linux-gnu
...
build-linux-aarch64: ## Build for Linux ARM64
	...
	@CROSS_LOG=info cross build --release --target aarch64-unknown-linux-gnu
...
build-macos-x86_64: ## Build for macOS x86_64 (Intel)
	...
	@CROSS_LOG=info cross build --release --target x86_64-apple-darwin
