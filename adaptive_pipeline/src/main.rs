...
async fn restore_file_from_adapipe_v2(
    ...
    stage_services.insert("brotli".to_string(), compression_service.clone() as Arc<dyn adaptive_pipeline_domain::services::StageService>);
    stage_services.insert("gzip".to_string(), compression_service.clone() as Arc<dyn adaptive_pipeline_domain::services::StageService>);
    stage_services.insert("zstd".to_string(), compression_service.clone() as Arc<dyn adaptive_pipeline_domain::services::StageService>);
    stage_services.insert("lz4".to_string(), compression_service.clone() as Arc<dyn adaptive_pipeline_domain::services::StageService>);
    stage_services.insert("aes256gcm".to_string(), encryption_service.clone() as Arc<dyn adaptive_pipeline_domain::services::StageService>);
    stage_services.insert("aes128gcm".to_string(), encryption_service.clone() as Arc<dyn adaptive_pipeline_domain::services::StageService>);
    stage_services.insert("chacha20poly1305".to_string(), encryption_service.clone() as Arc<dyn adaptive_pipeline_domain::services::StageService>);
    stage_services.insert("base64".to_string(), Arc::new(Base64EncodingService::new()) as Arc<dyn adaptive_pipeline_domain::services::StageService>);
    stage_services.insert("pii_masking".to_string(), Arc::new(PiiMaskingService::new()) as Arc<dyn adaptive_pipeline_domain::services::StageService>);
    stage_services.insert("tee".to_string(), Arc::new(TeeService::new()) as Arc<dyn adaptive_pipeline_domain::services::StageService>);
    stage_services.insert("passthrough".to_string(), Arc::new(PassThroughService::new()) as Arc<dyn adaptive_pipeline_domain::services::StageService>);
    stage_services.insert("debug".to_string(), Arc::new(DebugService::new(Arc::new(MetricsService::new().unwrap()))) as Arc<dyn adaptive_pipeline_domain::services::StageService>);
