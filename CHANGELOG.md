...
- COMMIT MESSAGE FOR PHASE 2 (Please validate before committing)
- COMMIT MESSAGE FOR PHASE 3 (Please validate before committing)
- Bump version to v2.0.0
- Update Cargo.lock for v2.0.0
- Bump version to v2.0.0

### Removed

- Remove file paths from ProcessingContext (breaking change)
